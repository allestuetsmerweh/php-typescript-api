...
final class IsoTimeTest extends UnitTestCase {
    public function testSerializeIsoTime(): void {
        ...
        $this->assertSame('13:27:35', $iso_date->toWire());
    }

    public function testDeserializeIsoTime(): void {
        $iso_date = IsoTime::fromWire('23:59:59');
    ...
    public function testFromDateTime(): void {
        $iso_date = IsoTime::fromDateTime(new \DateTime('13:27:35'));

        $this->assertSame('13:27:35', $iso_date?->format('H:i:s'));
    }

    public function testFromDateTimeNull(): void {
        $this->assertNull(IsoTime::fromDateTime(null));
    }
